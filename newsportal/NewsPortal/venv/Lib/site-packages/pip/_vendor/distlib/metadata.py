...
class Metadata(object):
    ...
    LEGACY_MAPPING = {
        ...
        ('extensions', 'python.NewsPortal', 'project_urls', 'Home'): 'Home-page',
        ('extensions', 'python.NewsPortal', 'contacts', 0, 'name'): 'Author',
        ('extensions', 'python.NewsPortal', 'contacts', 0, 'email'): 'Author-email',
